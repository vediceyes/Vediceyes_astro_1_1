...
class Ui_SAMainWindow(object):
    def setupUi(self, SAMainWindow):
        ...
        self.UTCDisplay = QtWidgets.QLabel(self.formLayoutWidget)
        self.UTCDisplay.setText("")
        self.UTCDisplay.setObjectName("UTCDisplay")
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.UTCDisplay)
    ...
    def retranslateUi(self, SAMainWindow):
        ...
        self.label_11.setText(_translate("SAMainWindow", "UTC"))
