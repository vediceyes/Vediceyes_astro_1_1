...
class Chart(object):
    ...
    def GetAyanamsa(self):
        ...
        ayan = swe.get_ayanamsa_ut(Bday_accurate[1])
...
Hscope.ReadingSetup("Anand Ramamurthy","Chennai, India","Sidereal")

#Setup Eph based on Gio location
...
(HouseDict, HousePosList) = Hscope.CaclHouses()

Hscope.CalcPlanets(HouseDict)

Hscope.getASC(HouseDict)
